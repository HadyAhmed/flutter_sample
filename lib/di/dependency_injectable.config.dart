...
import 'package:flutter_sample/di/app_module.dart' as _i36;
...
import 'package:flutter_sample/domain/usecase/user/get_user_data_uc.dart'
    as _i30;
import 'package:flutter_sample/domain/usecase/user/get_user_uc.dart' as _i31;
import 'package:flutter_sample/domain/usecase/user/login_uc.dart' as _i32;
import 'package:flutter_sample/domain/usecase/user/logout_uc.dart' as _i33;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i14.UsersDataSource>(
        () => _i15.UsersDataSourceImpl(gh<_i7.FirebaseFirestore>()));
    ...
    gh.factory<_i28.GetDarkModeUseCase>(
        () => _i28.GetDarkModeUseCase(gh<_i25.AppPreferencesRepo>()));
    gh.factory<_i29.GetRecentlyPostsUseCase>(
        () => _i29.GetRecentlyPostsUseCase(gh<_i19.PostRepository>()));
    gh.factory<_i30.GetUserDataUseCase>(
        () => _i30.GetUserDataUseCase(gh<_i21.UserRepo>()));
    gh.factory<_i31.GetUserUseCase>(
        () => _i31.GetUserUseCase(gh<_i21.UserRepo>()));
    gh.factory<_i32.LoginUseCase>(() => _i32.LoginUseCase(gh<_i21.UserRepo>()));
    gh.factory<_i33.LogoutUseCase>(
        () => _i33.LogoutUseCase(gh<_i21.UserRepo>()));
    gh.factory<_i34.ResetPasswordUseCase>(
        () => _i34.ResetPasswordUseCase(gh<_i21.UserRepo>()));
    gh.factory<_i35.SetDarkModeUseCase>(
        () => _i35.SetDarkModeUseCase(gh<_i25.AppPreferencesRepo>()));
    return this;
  }
}
